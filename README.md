    ...
    <div class="col">
      <div class="card">
       ...
       <div class="card-body">
        ...
        <p class="card-text-center">GRAB menjadi salah satu aplikasi ojek online yang populer dikalangan masyarakat untuk saat ini, Sehingga GRAB menjadi salah satu perusahaan yang besar dibidang jasa</p>
      </div>
       </div>
     </div>
    </div>
